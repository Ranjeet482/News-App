...
class AppDelegate: UIResponder, UIApplicationDelegate, DashboardAPIDelegate {
    ...
    fileprivate func createMenuView(){
        ...
        nvc.navigationBar.backgroundColor = Utility.sharedInstance.hexStringToUIColor(hex: "0E80E4")
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions:
        ...
        self.createMenuView()
        UINavigationBar.appearance().barTintColor = Utility.sharedInstance.hexStringToUIColor(hex: "0E80E4")
